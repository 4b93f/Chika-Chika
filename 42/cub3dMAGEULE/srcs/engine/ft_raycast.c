...
/*   Updated: 2020/10/31 17:31:02 by chly-huc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ft_raycast(t_params *params,t_ray *ray, t_color *color)
{
	...
	while (++x < params->screenwidth)
	{
		...
		params->tex->texpos = (params->ray->drawstart - params->screenheight / 2 + params->ray->lineheight / 2) * params->tex->step;
		...
		{
			params->color->b = params->tex->tex[params->tex->texnum][params->tex->texx * 4 + params->tex->texy * params->tex->sizeline + 0];
			params->color->g = params->tex->tex[params->tex->texnum][params->tex->texx * 4 + params->tex->texy * params->tex->sizeline + 1];
			params->color->r = params->tex->tex[params->tex->texnum][params->tex->texx * 4 + params->tex->texy * params->tex->sizeline + 2];
			params->color->a = params->tex->tex[params->tex->texnum][params->tex->texx * 4 + params->tex->texy * params->tex->sizeline + 3];
